...
var Atu = (function () {
  ...
  $.fn = {
    ...
    parents: function (selector) {
      ...
      while (parent && parent[0].tagName !== 'HTML') {
        if ($(parent).parent().find(selector).length > 0) {
          return parent;
        }
      ...
      if (arguments.length === 0) {
        ...
        for (let i = 0; i < attributes.length; i++) {
          ...
          if (attr.name.startsWith('data-')) {
            ...
            dataObj[key] = deserializeValue(attr.value);
          }
        }
        return dataObj;
      }
    ...
    scale: function () {
      ...
      return this.each(function (idx) {
        $(this).css({
          "transform": s, "-webkit-transform": s, "-moz-transform": s, "-ms-transform": s,
  ...
  ['width', 'height'].forEach(function (dimension) {
    ...
    $.fn[dimension] = function (value) {
      var offset, eo = this[0], el = $(this)
      if (value === undefined) {
        if (isWindow(eo)) {
          return eo['inner' + dimensionProperty]
        }
        if (isDocument(eo)) {
          return eo.documentElement['client' + dimensionProperty]
        }
        if (el.css("display") == "none") {
          el.show()
          const v = el[dimension]();
          el.hide()
          return v
        } else {
